...
//        String merchant_key="I9ySB2m8";
    	
    	
        String salt = "HKbXMk0PgR";  // need to set Production salt key
       
        String action1 = "";
        String base_url = "https://test.payu.in"; // need to set Production URL(https://secure.payu.in/_payment)
        error = 0;
        String hashString = "";
